...
function ns:ParsePayload(raw)
  ...
  local meta = { schema = nil, bridge = "", generated = 0, rows = nil, acked = 0, new = {}, hosts = {} }
  ...
  -- refused whole: half a board is worse than a labelled stale one.
  if meta.rows ~= nil and meta.rows ~= #sessions then
    return nil
  end
